...
import { fetchRestaurants } from "../../redux/slices/customer/restaurantSlice";
    ...
    return (
        <>
            ...
            <div className="container mt-4">
                <h2 className="mb-4 fw-bold">Restaurants</h2>
                ...
                <div className="row">
                    {restaurants.map((restaurant) => (
                        <div key={restaurant.id} className="col-12 col-sm-6 col-md-4 col-lg-3 mb-4"
                        onClick={() => handleRestaurantClick(restaurant.id)} 
                        style={{ cursor: "pointer" }}>
                            <div className="card border-0" style={{ boxShadow: "0px 0px 5px rgba(0, 0, 0, 0.2)" }}>
                                <img
                                    src={
